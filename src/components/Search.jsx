...
const Search = () => {
  ...
  return (
    <div className={` ${isOpen ? 'top-0' : '-top-full'} w-screen left-0 right-0 absolute h-1/2 shadow-2xl transition-all duration-300 z-20 bg-white`}>
      ...
      <div className="ml-12 w-[80%] mt-5 select-none flex  border-b-slate-300 border-b-[3px] gap-10"><input className=' outline-none placeholder:text-slate-500 font-bold text-2xl  pl-1 pb-0 search w-[93%]' type="search" id="gsearch" name="gsearch" placeholder='Search Products'></input>
