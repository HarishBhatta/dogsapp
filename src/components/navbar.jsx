...
export default function NavBar(){
    const { isOpen, setIsOpen, handleClose } = useContext(SearchContext);
    ...
    return(
        <div className="h-[80px] bg-white w-full flex navbar">
            ...
            <div className=" w-[750px] ml-[300px] flex gap-4">
                ...
                <div className= "mt-8 ml-2 flex gap-5">
                    {/* <div onClick={handleClose()} className = 'cursor-pointer flex relative'>
